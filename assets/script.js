let chapters = {
    debut: {
        ...
        boutons: [{titre: "Le laissez mourir", destination: "noyade"},{titre: "Tu le sauves", destination: "Rejoin"},{titre: "Tu lui rends ses épées", destination: "Rejoin"}]
    },
    alliance: {
        ...
        boutons: [{titre: "Oui", destination: "Carte"},{titre: "Non", destination: "Perte"}]
    },
    dilemme: {
        ...
        boutons: [{titre: "Oui", destination: "Famine"},{titre: "Non", destination: "Provisions"}]
    },
    naviguer: {
        titre: "Le Dilemme de la Nourriture",
        ...
        boutons: [{titre: "Vous", destination: "Perdu"},{titre: "Chasseur de pirates", destination: "Tsunami"},{titre: "La voleuse", destination: "Tresor"}]
    }
...
function goToChapter(chapitre) {
    const chapter = chapters[chapitre];
    if (chapters) {
        console.log("Titre du chapitre:", chapter.titre);
        console.log("Chapitre:", chapter.description);
        console.log("Boutons:", chapter.boutons.map(bouton => bouton.destination).join(', '));
    } else {
